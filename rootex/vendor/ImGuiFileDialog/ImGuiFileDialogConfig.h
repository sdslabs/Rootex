...
#define ICON_IGFD_ADD ICON_ROOTEX_PLUS
#define ICON_IGFD_BOOKMARK ICON_ROOTEX_BOOKMARK
#define ICON_IGFD_CANCEL ICON_ROOTEX_WINDOW_CLOSE
#define ICON_IGFD_DRIVES ICON_ROOTEX_DATABASE
#define ICON_IGFD_EDIT ICON_ROOTEX_PENCIL_SQUARE_O
#define ICON_IGFD_FILE ICON_ROOTEX_FILE
#define ICON_IGFD_FOLDER ICON_ROOTEX_FOLDER
#define ICON_IGFD_FOLDER_OPEN ICON_ROOTEX_FOLDER_OPEN
#define ICON_IGFD_LINK ICON_ROOTEX_EXTERNAL_LINK
#define ICON_IGFD_OK ICON_ROOTEX_CHECK
#define ICON_IGFD_REFRESH ICON_ROOTEX_REFRESH
#define ICON_IGFD_REMOVE ICON_ROOTEX_MINUS
#define ICON_IGFD_RESET ICON_ROOTEX_REPEAT
#define ICON_IGFD_SAVE ICON_ROOTEX_FLOPPY_O
#define ICON_IGFD_SEARCH ICON_ROOTEX_SEARCH
...
inline static const char FONT_ICON_BUFFER_NAME_ROOTEX[5415+1] =
    "7])#######R9c$c'/###O@?>#+lQS%Ql#v#X^@iFuP:Ul,7###cP'##4<U=B;w.GM]cFe-]br-$KQshF=I&##-`'##?V`w'<op0FJVcenbkVw02)[w'75=RDL>5$Y+)###nIq-$Mu@['"
