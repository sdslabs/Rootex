...
{
	return new TextVisual2DComponent(ResourceLoader::CreateFontResourceFile("game/assets/fonts/noto_sans_50_regular.spritefont"), "Hello World!", { 1.0f, 1.0f, 1.0f, 1.0f }, Mode::None);
}
