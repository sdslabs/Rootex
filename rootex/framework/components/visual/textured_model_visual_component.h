...
class TexturedModelVisualComponent : public ModelVisualComponent
{
	...
	TexturedModelVisualComponent(const unsigned int& renderPass, Ref<TextureMaterial> material, VisualModelResourceFile* resFile, ImageResourceFile* imageRes, Texture* texture, bool visibility);
